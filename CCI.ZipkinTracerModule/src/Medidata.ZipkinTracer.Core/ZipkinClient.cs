...
using CCI.ZipkinTracer.Core.Helpers;
...
namespace CCI.ZipkinTracer.Core
{
    public class ZipkinClient: ITracerClient
    {
        ...
        public Span StartServerTrace(Uri requestUri, string methodName)
        {
            ...
            logger.Log(LogLevel.Debug, () => $"Starting trace for {requestUri}");
        ...
        public void EndServerTrace(Span serverSpan)
        {
            ...
            logger.Log(LogLevel.Debug, () => $"Stopping trace for {serverSpan.ParentId}");
